...
public class ControllerManager: MonoBehaviour
{
    ...
    public GameObject headgazeModel;
    ...
    public void ToggleRightLaserPointer() {
        rightLaserPointerActive = !rightLaserPointerActive;

        if(GetComponent<AvatarAppearance>() != null)
        {
            GetComponent<AvatarAppearance>().SetPointer(rightLaserPointerActive);
        }
    }
    ...
    protected virtual void LateUpdate()
    {
        ...
        switch (laserPointerActiveMode)
        {
            ...
            case LaserPointerActiveModeEnum.ToggleByMenuClick:
                ...
                break;
            case LaserPointerActiveModeEnum.ToggleOnPadPressed:
                if (ViveInput.GetPressEx(HandRole.RightHand, ControllerButton.Pad))
                {
                    ToggleRightLaserPointer();
                    needUpdate = true;
                }
    ...
    public void UpdateActivity()
    {
        ...
        if (headgazeModel != null)
        {
            headgazeModel.SetActive(!rightLaserPointerShouldActive);
        }
