...
namespace HTC.UnityPlugin.Pointer3D
{
    public static class ExecutePointer3DEvents
    {
        ...
        public static readonly ExecuteEvents.EventFunction<IPointer3DHoverHandler> HoverHandler = Execute;
        private static void Execute(IPointer3DHoverHandler handler, BaseEventData eventData)
        {
            handler.OnPointer3DHover(ExecuteEvents.ValidateEventData<Pointer3DEventData>(eventData));
        }
    }
}