...
namespace Normal.Realtime {
    ...
    public class RealtimeAvatarManagerEditor : Editor {
        ...
        private SerializedProperty offlineAvatarPrefabProperty { get { return serializedObject.FindProperty("_offlineAvatar"); } }
        ...
        public override void OnInspectorGUI() {
            ...
            // Offline Avatar
            offlineAvatarPrefabProperty.objectReferenceValue = EditorGUILayout.ObjectField("Offline Avatar", offlineAvatarPrefabProperty.objectReferenceValue, typeof(GameObject), true);
