...
namespace HTC.UnityPlugin.Vive
{
    public static partial class VIUSettingsEditor
    {
        ...
        [SettingsProvider]
        static SettingsProvider OnNewVIUPreferenceGUI()
        {
            //- If .Project it will appear in Project Settings instead
            //- Even in Preferences window, it is possible to place it outside of Preferences tree.
            return new SettingsProvider("VIU Settings", SettingsScope.User)
            {
                //This is just the drawer. There are more to customize in the new provider system.
                guiHandler = (searchContext) => OnVIUPreferenceGUI(),
            };
        }
#else
